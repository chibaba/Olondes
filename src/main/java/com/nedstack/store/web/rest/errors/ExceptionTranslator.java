package com.nedstack.store.web.rest.errors;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleEmailAlreadyUsedException(com.nedstack.store.service.EmailAlreadyUsedException ex, ServerWebExchange request) {
    ...
    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleUsernameAlreadyUsedException(com.nedstack.store.service.UsernameAlreadyUsedException ex, ServerWebExchange request) {
        LoginAlreadyUsedException problem = new LoginAlreadyUsedException();
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName,  true, problem.getEntityName(), problem.getErrorKey(), problem.getMessage()));
    }

    @ExceptionHandler
    public Mono<ResponseEntity<Problem>> handleInvalidPasswordException(com.nedstack.store.service.InvalidPasswordException ex, ServerWebExchange request) {
